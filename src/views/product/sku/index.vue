<template>
  <el-card>
    <el-table border style="margin: 10px 0px" :data="skuArr">
      ...
      <el-table-column prop="skuName" label="名称" width="100px" show-overflow-tooltip></el-table-column>
      ...
      <el-table-column label="操作" width="300px" fixed="right">
        <template #="{ row, $index }">
          <el-button @click="updateSale(row)" :type="row.isSale == 1 ? 'primary' : 'info'" size="small"
    ...
    <el-pagination @size-change="handler" @current-change="getHasSku" v-model:current-page="pageNo"
      v-model:page-size="pageSize" :page-sizes="[10, 20, 30, 40]" :background="true"
  ...
  <el-drawer v-model="drawer">
    ...
    <template #default>
      ...
      <el-row style="margin: 10px 0;">
        ...
        <el-col :span="18">
          <el-tag v-for="(item, index) in skuInfo.skuAttrValueList" :key="item.id" style="margin: 0px 5px;">{{
      ...
      <el-row style="margin: 10px 0;">
        ...
        <el-col :span="18">
          <el-tag v-for="(item, index) in skuInfo.skuSaleAttrValueList" :key="item.id" style="margin: 0px 5px;">{{
